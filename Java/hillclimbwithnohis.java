...
public class HillClimbNoHis {
    public static void main(String[] args) {
        ...
        List<String> path = hillclimb(cities, graph, heuristics, startCit, endCit);
        if (path != null) {
    ...
    static List<String> hillclimb(String[] cities, int[][] graph, int[] heuristics, String startCit, String endCit) {
